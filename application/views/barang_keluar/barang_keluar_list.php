    ...
    <!--isi-->
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
				...
				<?php echo anchor(site_url('barang_keluar/word'), 'Word', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "barang_keluar/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "nama_barang"},{"data": "banyak"},{"data": "harga"},{"data": "jenis"},{"data": "nama_kasubag"},{"data": "waktu"},
                        {
                            "data" : "action",
                            "orderable": false,
