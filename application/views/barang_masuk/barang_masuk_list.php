    ...
    <!--isi-->
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
				...
				<?php echo anchor(site_url('barang_masuk/word'), 'Word', 'class="btn btn-primary"'); ?>
            </div>
                    ...
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "kd_barang"},{"data": "nama_barang"},{"data": "waktu_masuk"},{"data": "harga"},{"data": "banyak"},{"data": "jenis"},{"data": "nama_kasubag"},
                        {
                            "data" : "action",
                            "orderable": false,
